...
console.log(text.replace(/Manuel Marques de Sousa/g, 'Chrysthian Moizes'));
...
console.log(text.replace(/brasileiro/g, 'mineiro'));
...
console.log(text.replace(/(O Centauro de Luvas)/g, function(texto, frase){
...
function replaceDate(texto, dia, mes, ano){
