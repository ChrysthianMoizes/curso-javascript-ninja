...
var regexNumbers = new RegExp('^\\d+', 'gm');
...
"[ '10', '50' ]"
*/
var text = '10 anos.\n50 discos vendidos.\nE nem 20% dos meus amigos o conhece.';
...
console.log(hasClass(markup, new RegExp('container', 'gm')) + ' para a classe container');
console.log(hasClass(markup, new RegExp('text', 'gm')) + ' para a classe text');
console.log(hasClass(markup, new RegExp('date', 'gm')) + ' para a classe date');
console.log(hasClass(markup, new RegExp('excerpt', 'gm')) + ' para a classe excerpt');
console.log(hasClass(markup, new RegExp('main', 'gm')) + ' para a classe main');
