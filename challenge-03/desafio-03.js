...
pessoa.nomeCompleto();	// 'Olá! Meu nome é Chrysthian Moizes!'
...
pessoa.mostrarPeso();	// 'Eu tenho 75Kg.'
...
pessoa.caminhouQuantosMetros;	// 26
...
pessoa.apresentacao = function(){
	...
	+ pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' 
	+ pessoa.idade + ' ' + idade + ', ' 
	+ pessoa.altura + ' de altura, meu peso é ' + pessoa.peso + 'Kg, e só hoje, eu já caminhei ' 
